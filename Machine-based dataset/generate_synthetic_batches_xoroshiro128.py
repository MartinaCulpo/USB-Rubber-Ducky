...
# === PRNG: xoroshiro128+ (corretto)
def prng_xoroshiro128(seed, size=1):
    bitgen = Xoroshiro128(seed)
...
if __name__ == "__main__":
    ...
    # Calcola range realistici + epsilon
    ...
    for batch_num in range(num_batches):
        ...
        for sid, sentence in enumerate(batch_sentences):
            ...
            for i, c in enumerate(sentence):
                ...
                hold = int(hold_range[0] + prng_xoroshiro128(sentence_id + i, 1)[0] * (hold_range[1] - hold_range[0]))
                flight = int(flight_range[0] + prng_xoroshiro128(sentence_id + i + 1000, 1)[0] * (flight_range[1] - flight_range[0]))
